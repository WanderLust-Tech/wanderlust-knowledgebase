...
export const ProgressDashboard: React.FC = () => {
  ...
  // Early return if not authenticated (though this should be handled by ProtectedRoute)
  if (!isAuthenticated) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-blue-800 dark:text-blue-200">Authentication Required</h2>
          </div>
          <p className="text-blue-700 dark:text-blue-300">
            Please sign in to access your learning progress dashboard.
          </p>
        </div>
      </div>
    );
